...
# 训练函数
def train_model(optimizer_type, lr, batch_size, use_augmentation, use_early_stopping, num_epochs=20):
    print(f"\n{'='*60}")
    print(f"训练配置:")
    ...
    print(f"  Early Stopping: {'是' if use_early_stopping else '否'}")
    print(f"{'='*60}")
...
# 实验1: SGD, 0.01, 64, 否, 否
result1 = train_model('SGD', 0.01, 64, False, False, num_epochs=20)

# 实验2: Adam, 0.001, 64, 否, 否
result2 = train_model('Adam', 0.001, 64, False, False, num_epochs=20)

# 实验3: Adam, 0.001, 128, 否, 是
result3 = train_model('Adam', 0.001, 128, False, True, num_epochs=20)

# 实验4: Adam, 0.001, 64, 是, 是
result4 = train_model('Adam', 0.001, 64, True, True, num_epochs=20)
...
print("\n" + "="*60)
print("所有实验完成！结果已保存到 experiment_results.json")
print("="*60)
